...
public class EdgeDetection_InnerOuter : ScriptableRendererFeature
{
    ...
    public class EdgeDetectionSettings
    {
        ...
        [Header("Edges")]
        [Range(0, 15)] public int outlineThickness = 2;

        [Header("Relative Colour")]
    ...
    public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
    {
        ...
        if (edgeDetectionMaterial == null)
        {
            edgeDetectionMaterial = CoreUtils.CreateEngineMaterial(
                Shader.Find("Hidden/Edge Detection InnerOuter")
            );

            if (edgeDetectionMaterial == null)
            {
                Debug.LogWarning("EdgeDetection_InnerOuter: shader could not be found.");
                return;
            }
        }
