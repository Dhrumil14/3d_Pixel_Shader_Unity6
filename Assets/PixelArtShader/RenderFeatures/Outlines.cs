...
public class Outlines : ScriptableRendererFeature
{
    ...
    public class OutlineSettings
    {
        ...
        [Header("Sampling")]
        // NOTE: Increased default radius so lines survive the pixel downsample!
        [Range(0.5f, 6f)] public float kernelRadius = 2.5f;
    ...
    public override void Create()
    {
        ...
        {
            // Runs right before your Pixel pass grabs the screen
